...
function startup() {
        var xlist = ["Uber", "Snapchat", "Facebook", "Tinder", "Venmo", "Airbnb", "Twitter", "Netflix", "Dropbox", "Dribble", "Buzzfeed", "Github", "Vine", "Periscope", "Instagram", "Foursquare", "Medium", "Wikipedia", "Youtube", "Yelp", "Comcast", "Social Media Platform"];
